				...
				if(!exists)
				  ...
				  if(apple.points.size()<1)
				  {
				    ...
				    try {
				          ...
				          URL url = new URL("http://ichart.finance.yahoo.com/table.txt?a="+bmonth+"&b="+bday+"&c="+byear+"&d="+emonth+"&e="+eday+"&f="+eyear+"&g=d&s="+apple.stockAbrev);
										...
										public void onClick(View v) {
											if(apple2.isPlay)
											 ...
											 if(!apple2.isPlay){
												 	...
												 	apple2.isPlay=true;
												 	MainActivity.rgraph.set(graphPos,apple2);
											       }
											       else{
											    	   apple2.isPlay=false;
				...
				AsyncTask<Void, Void, Void> updater = new AsyncTask<Void, Void, Void>() {
					...
					protected void onPostExecute(Void result) {
						...
						Log.d("point", Long.toString(apple2.points.get(apple2.points.size()-1).second)+"-"+Double.toString(apple2.points.get(apple2.points.size()-1).first));
							...
							if(response)
							 {
								graphView2.appendData(new GraphViewData(apple2.points.get(apple2.points.size()-1).second ,apple2.points.get(apple2.points.size()-1).first), true, 31);
								apple2.gvs=graphView2;
