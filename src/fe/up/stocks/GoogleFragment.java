				...
				if(!exists)
				  ...
				  if(google.points.size()<1)
				  {
				    ...
				    try {
				          ...
				          URL url = new URL("http://ichart.finance.yahoo.com/table.txt?a="+bmonth+"&b="+bday+"&c="+byear+"&d="+emonth+"&e="+eday+"&f="+eyear+"&g=d&s="+google.stockAbrev);
										...
										public void onClick(View v) {
											if(google2.isPlay)
											 ...
											 if(!google2.isPlay){
												 	...
												 	google2.isPlay=true;
												 	MainActivity.rgraph.set(graphPos,google2);
											       }
											       else{
				...
				AsyncTask<Void, Void, Void> updater = new AsyncTask<Void, Void, Void>() {
					...
					protected void onPostExecute(Void result) {
						...
						Log.d("point", Long.toString(google2.points.get(google2.points.size()-1).second)+"-"+Double.toString(google2.points.get(google2.points.size()-1).first));
							...
							if(response)
							 {
								graphView2.appendData(new GraphViewData(google2.points.get(google2.points.size()-1).second ,google2.points.get(google2.points.size()-1).first), true, 31);
								google2.gvs=graphView2;
