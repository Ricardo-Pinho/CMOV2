...
public class LinearGraph extends Activity{
	...
	public Intent getIntent(Context context) {
		...
		for( int i = sgraph.points.size()-1; i >= 0; i--)
		{
			series.add(sgraph.points.get((sgraph.points.size()-1-i)).second, sgraph.points.get(i).first);
		...
		Intent intent = ChartFactory.getLineChartIntent(context, dataset, mRenderer, sgraph.stockName);
		return intent;
